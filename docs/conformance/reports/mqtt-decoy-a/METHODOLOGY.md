# Methodology — mqtt-decoy-a

## Scope

Remote protocol-surface grade of an operator-provided MQTT honeypot at `98.90.197.80:1883`.
...
See the companion [TUTORIAL](TUTORIAL.md). Use `protocol=mqtt` and `ports_map.mqtt=1883` against `98.90.197.80`.
