...
**UHBS:** 4.6.1 · **generic** TCP on container port **8080**, host **19104**. Lab config `config.uhbs-lab.yml` enables a single TCP listener without banners to keep behavior deterministic for Module A.
...
Skip hubs explain why no SCORECARD exists yet. See [READING-UHQS.md](../READING-UHQS.md). Informative only · UHBS 4.6.1 · isolate honeypot networks in real deployments.
...
- UHBS 4.6.1 remains an open-source evaluation framework (Apache-2.0) — informative proof only.
