...
**UHBS:** 5.0.0 · **generic** TCP on container port **8080**, host **19104**. Lab config `config.uhbs-lab.yml` enables a single TCP listener without banners to keep behavior deterministic for Module A.
...
Skip hubs explain why no SCORECARD exists yet. See [READING-UHQS.md](../READING-UHQS.md). Informative only · UHBS 5.0.0 · isolate honeypot networks in real deployments.
...
- UHBS 5.0.0 remains an open-source evaluation framework (Apache-2.0) — informative proof only.
