...
| Docker image | `uhbs:5.0.0-full` | `uhbs:5.0.0` |
...
│  uhbs:5.0.0[-full]  │ ──────────────────────────────── │  espot-lab :9200     │
...
Follow [TUTORIAL.md](TUTORIAL.md). If your UHQS differs, check: image digests, TPS path, `UHBS_QUICK`, telemetry mount, SAST image (`uhbs:5.0.0` vs `uhbs:5.0.0-full`), and UHBS git commit. File discrepancies with the reproduced `report.json` attached.
