...
**Upstream:** [betheroot/sticky_elephant](https://github.com/betheroot/sticky_elephant) · **UHBS:** 5.0.0
...
UHBS 5.0.0 evaluation proof is **informative** — not a certification or endorsement. Re-run after upstream or TPS changes; do not invent scores without regenerating artifacts.
