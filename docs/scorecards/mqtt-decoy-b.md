...
**UHBS:** **4.6.1** · **Class:** Low-Interaction · **Protocol / surface:** `mqtt`  
**Target id (lab):** `mqtt-decoy-b` · **Evaluation date:** 2026-09-07  
**Endpoint:** `3.84.184.144:1883`

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| **Full (authoritative)** | **21.41** | **F** | **0.3025** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [mqtt-decoy-b / mqtt](../conformance/reports/mqtt-decoy-b/mqtt/index.md) · [Tutorial](../conformance/reports/mqtt-decoy-b/TUTORIAL.md) · [Methodology](../conformance/reports/mqtt-decoy-b/METHODOLOGY.md)  
...
| B — Behavioral Realism | 65.0 | Session realism (PING/UNSUB/pub-sub). Missing echo ⇒ not a real broker fan-out. |
...
```text
====================================================================================
                  UNIVERSAL HONEYPOT BENCHMARK SCORECARD v4.6.1
====================================================================================
...
Environment           : Operator-provided honeypot endpoint (3.84.184.144:1883)
------------------------------------------------------------------------------------
EVALUATION MODULE                     SCORE (0-100)    WEIGHT    STATUS
------------------------------------------------------------------------------------
Module A: Protocol Fidelity         :  86.8/100       0.30     PASSED (fsm=67 nego=100 timing=100)
Module B: Behavioral Realism        :  65.0/100       0.15     PARTIAL (mqtt.payload.pubsub_echo)
...
Module E: Scalability & Latency     : 100.0/100       0.10     PASSED (P50=57.7ms P95=65.7ms P99=66.9ms TPS_limit=300.0ms proto=mqtt)
...
FINAL COMPOSITE SCORE (UHQS 4.6.1)      : 21.41 / 100
...
Re-run notes are in the [tutorial](../conformance/reports/mqtt-decoy-b/TUTORIAL.md). Limits are in the [methodology](../conformance/reports/mqtt-decoy-b/METHODOLOGY.md).

Machine-readable fixture: [`../conformance/fixtures/mqtt-decoy-b.scorecard.json`](../conformance/fixtures/mqtt-decoy-b.scorecard.json).
