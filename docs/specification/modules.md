...
UHBS v4.6.1 defines six evaluation modules. Module **D** is the **Safety Gate**; a containment score below 95 applies an exponential penalty to the composite UHQS.
