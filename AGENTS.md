...
- Spec / package version: **4.6.0** · License: **Apache-2.0**
...
docker run --rm -v "$PWD:/work" -w /work uhbs:4.6.0 validate-scorecard docs/conformance/fixtures/cowrie-low-interaction.scorecard.json
```
