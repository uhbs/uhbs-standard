...
- Spec / package version: **5.0.0** · License: **Apache-2.0**
...
docker run --rm -v "$PWD:/work" -w /work uhbs:5.0.0 validate-scorecard docs/conformance/fixtures/cowrie-low-interaction.scorecard.json
```
