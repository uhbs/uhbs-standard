...
> Spec version: **4.6.0** · Status: **Experimental** · Last updated: 2026-08-01
>
...
| --- | --- | --- |
| 1 | Normative spec (RFC 2119, document status) | Done for v4.6.0 |
...
| Component | Role |
| --- | --- |
| `run_benchmark.py` | UHBS v4.6.0 orchestrator (phases 1–5) |
...
- [x] Package as installable `uhbs[lab]` / `uhbs-lab`, version == spec `4.6.0`
